...
\section{Objectives}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Lower vertex counts on the graphs will allow for a faster simulation, this program should at maximum be able to handle a graph with 50 vertices.
        \end{itemize}
        ...
        \item Undo/redo functionality
        \begin{itemize}
            \item This program should include options for undoing and redoing actions, allowing users to correct mistakes. This is a widespread feature in other software as explored in \autoref{current-systems}. This could be isolated to the network construction component.
        \end{itemize}
    \end{itemize}
