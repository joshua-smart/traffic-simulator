...
\section{Control Flow}
    ...
    I will manage the major program control flow using a finite state machine
...
\section{Network Testing}
    ...
    \subsection{Pathfinding}
        ...
        For this project I have decided to implement Dijkstra's shortest path algorithm for route finding as it is designed for operating on a graph data structure, and it is garuntted to find the shortest valid path between two nodes.

        Listing \ref{Dijkstra-implementation} shows my implementaion of this algorithm in TypeScript, in the example it is implemented as a function. However in the final program it will quite likely be implemented as a method of the \mintTS{Graph} class.
