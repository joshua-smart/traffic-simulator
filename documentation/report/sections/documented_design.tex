...
\section{Class structure}
    ...
    \paragraph{Vector2}
        ...
        \inlinecode{Vector2.sub(a, b)}, \inlinecode{Vector2.mult(v, x)},
        ...
        \inlinecode{v.add(b)},
        \inlinecode{v.sub(b)}, \inlinecode{v.mult(x)},
        \inlinecode{v.mag()},
        \inlinecode{v.sqr_mag()},
        \inlinecode{v.dot(b)}

        Each of these methods will be implemented with static and non-static variants, allowing for more flexible usages. I will be using \textbf{out-of-place [check]} methods which is a scheme I am more familiar with and allows for clearer syntax.
