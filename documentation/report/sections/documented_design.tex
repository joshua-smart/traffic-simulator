...
\section{Class structure}
    ...
    \paragraph{Vector2 -}
        ...
        \inlinecode{b.set_vertex(i, v)}, \inlinecode{b.interpolate(t)}, \inlinecode{b.get_point_at_distance(d)}, \inlinecode{b.get_normal(d)}, \\
        \inlinecode{b.get_curvature(d)}
        ...
        A queue structure will be used to model the routes followed by agents, this will require the following methods:

        \inlinecode{q.enqueue(e)}, \inlinecode{q.dequeue()}, \inlinecode{q.is_empty()}
