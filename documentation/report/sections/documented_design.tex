...
\section{Network Builder}
    ...
    This program will include undo/redo functionality on the network construction component specifically, this will be modelled using two stacks, one containing the user actions that have occured (the undo stack) and the other containing the actions that have been reapplied (the redo stack). \textbf{LINK DIAGRAM}

    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{undo-redo-diagram.jpg}
        \caption{}
